...
namespace QuanLyQuanTraSua
{
    public partial class TableManager : Form
    {
        ...
        private void btnSwitchTable_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(string.Format("Bạn thật sự muốn chuyển {0} qua {1}", (lsvBill.Tag as Table).Name, (cbSwitchTable.SelectedItem as Table).Name), "Thông báo", MessageBoxButtons.OKCancel) == System.Windows.Forms.DialogResult.OK)
            {    
